...
export default function Hero() {
  ...
  return (
    <div className="relative pt-24 py-20">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative text-left md:text-center">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-6 sm:mb-8  mt-6 sm:mt-8">
