  ...
  return (
    <div className="relative pt-24 py-20" id="order">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative ">
        ...
        <div className="relative mx-[-2rem] overflow-hidden rounded-lg border border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-6 px-8">
          {!formSubmitted ? (
            <>
