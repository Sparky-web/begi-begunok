        ...
        <div className="relative overflow-hidden rounded-lg border border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-6 sm:p-12">
          <div className="grid gap-6 sm:gap-8 items-center">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Для бизнеса</h2>
              <p className="text-base sm:text-lg text-muted-foreground mb-4 sm:mb-6">
                Специальные условия для компаний с регулярными потребностями в курьерской доставке. Наши специалисты
                подготовят персональное предложение с учетом особенностей вашего бизнеса и объемов доставок.
              </p>
