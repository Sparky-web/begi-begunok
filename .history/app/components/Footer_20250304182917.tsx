    ...
    <footer className="border-t border-border/40">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 py-8 sm:py-12">
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Курьерская служба доставки по Москве и области.</p>
        </div>
        <div>
          <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Услуги</h4>
        ...
        <div>
          <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Компания</h4>
          <ul className="space-y-1 sm:space-y-2">
            <li>
              <Link
                href="#"
        ...
        <div>
          ...
          <ul className="space-y-2 sm:space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-sm sm:text-base text-muted-foreground">{companyInfo.address}</span>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <span className="text-sm sm:text-base text-muted-foreground">{companyInfo.workingHours}</span>
            </li>
          </ul>
        </div>
      </div>
