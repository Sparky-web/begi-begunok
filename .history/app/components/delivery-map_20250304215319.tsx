...
mapboxgl.accessToken =
  "pk.eyJ1IjoidmxhZGlzbGF2YmFiaW5vdiIsImEiOiJjbTduZnB4eTcwMG1tMmpzZzNhbWZrb2s5In0.NL_uK8k5AVVOZOsKad70OQ";
    ...
    async (lng: number, lat: number) => {
      ...
      try {
        ...
        if (!sourcePointRef.current) {
          ...
          sourceMarker.current = new mapboxgl.Marker({ color: "#ff8a00" })
            .setLngLat([lng, lat])
            .addTo(map.current);
          ...
          destinationMarker.current = new mapboxgl.Marker({ color: "#ff8a00" })
            .setLngLat([lng, lat])
            .addTo(map.current);
        ...
        <div className="relative">
          ...
          <div className="relative">
            <Input
              ...
              onChange={(e) =>
                handleAddressChange(e.target.value, "destination")
              }
