...
const steps = [
  ...
  },
  {
    ...
    description:
      "Наш менеджер свяжется с вами для уточнения деталей и стоимости.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    description:
      "Курьер доставит посылку по адресу назначения в указанное время.",
  },
];
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="relative overflow-hidden rounded-lg border border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-4 sm:p-6 h-full">
                <div className="text-3xl sm:text-4xl font-bold text-primary/20 mb-3 sm:mb-4">
                  {step.number}
                </div>
