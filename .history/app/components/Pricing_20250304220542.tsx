      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="relative grid overflow-hidden rounded-lg content-between border border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-6 sm:p-8"
            >
              ...
              <Button className="w-full hover:opacity-90 text-sm sm:text-base mt-auto">
                Заказать
              </Button>
            </div>
          ))}
